...
'breaker-size':{primary:'breaker size calculator',intent:'Calculation intent: users want a preliminary overcurrent-device rating from a known load current and applicable design factor.',keywords:['breaker size calculator','circuit breaker size calculator','electrical breaker calculator','breaker sizing calculator','circuit breaker sizing','breaker size for amps','breaker size for load','how to size a breaker','breaker amp calculator','overcurrent protection calculator','breaker rating calculator','NEC breaker sizing','circuit protection calculator','breaker size chart','amp breaker size','electrical load breaker size','125 percent breaker sizing','continuous load breaker','standard breaker sizes','overcurrent device sizing','branch circuit breaker size','wire and breaker sizing','breaker size for motor','electrical breaker selection','breaker sizing calculator','circuit breaker sizing','overcurrent protection sizing','breaker amp rating','NEC breaker sizing','circuit protection calculator'],article:`A breaker size calculator helps estimate a preliminary overcurrent-device rating from a load current and design factor. CalcForge keeps the factor visible instead of assuming that one percentage applies to every load. This is important because breaker selection depends on the type of load, conductor ampacity and the applicable electrical rules.
